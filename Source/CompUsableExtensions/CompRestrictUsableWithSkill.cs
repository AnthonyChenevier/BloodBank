...
namespace BloodBank
{
    public class CompProperties_RestrictUsableWithSkill : CompProperties_UseEffect
    {
        public List<SkillRequirement> skillRequirements;
        public CompProperties_RestrictUsableWithSkill() { compClass = typeof(CompRestrictUsableWithSkill); }
    }

    public class CompRestrictUsableWithSkill : CompUsableRestriction
    {
        public CompProperties_RestrictUsableWithSkill Props => (CompProperties_RestrictUsableWithSkill)this.props;
